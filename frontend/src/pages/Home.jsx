        ...
        <div className="container hero-grid">
          <div>
            ...
            <div className="hero-tags">
              ...
              {["Logo Design", "WordPress", "Voice Over", "Video Editing", "AI Services", "Social Media", "SEO", "Translation"]}
            </div>
        ...
        <div className="container">
          <div className="cta">
            ...
            <div className="cta-buttons">
              <Link className="btn btn-lg" style={{ background: "white", color: "#222" }}>
                Start as a Buyer
              </Link>
              <Link className="btn btn-lg btn-outline-white">
                Become a Seller
              </Link>
            </div>
          </div>
